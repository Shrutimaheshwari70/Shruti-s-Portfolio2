  ...
  const projects = [
    {
      ...
      codeUrl: "https://github.com/Shrutimaheshwari70/Film-flicks",
      liveDemoUrl: "https://film-flicks.vercel.app",
      gradient: "from-red-500 to-pink-500"
    },
    {
      id: 2,
      title: "Admin Panel",
      description: "Secure, user-friendly dashboard to manage users, content, settings, permissions, analytics, and control overall app functionality.",
      tags: ["React.js", "HTML5", "Tailwind CSS", "JavaScript"],
    ...
    },
    {
      id: 3,
      title: "Nike Web Page",
      description: "Nike is a global brand known for athletic footwear, apparel, innovation, and empowering elite sports performance.",
      tags: ["HTML5", "CSS3", "Responsive", "Tailwind CSS"],
      image: "/images/project3.png",
      codeUrl: "https://github.com/Shrutimaheshwari70/Nike",
      liveDemoUrl: "https://nike-shruti.vercel.app",
      gradient: "from-orange-500 to-yellow-500"
    },
    {
      id: 4,
      title: "Disability App",
      description: "A physical or mental condition that significantly limits a person's movements, senses, communication, or daily life activities.",
      tags: ["React.js", "HTML5", "Tailwind CSS", "JavaScript"],
      image: "/images/project4.png",
      codeUrl: "https://github.com/Shrutimaheshwari70/disebility-react",
      liveDemoUrl: "https://disability-app.vercel.app",
      gradient: "to-teal-500"
    },
    {
      id: 5,
      title: "Interior Design",
      description: "Interior design enhances indoor spaces using creativity, aesthetics, functionality, color, and layout for better living.",
      tags: ["HTML5", "CSS3", "Tailwind CSS", "Responsive"],
      image: "/images/project5.png",
      codeUrl: "https://github.com/Shrutimaheshwari70/Interiror-design",
  ...
  return (
    <section className="min-h-screen bg-black text-white py-20 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <h3 className="text-2xl md:text-3xl font-bold mb-6">Want to see more projects?</h3>
          <motion.a
